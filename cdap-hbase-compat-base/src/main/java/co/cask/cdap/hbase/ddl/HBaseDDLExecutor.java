...
public interface HBaseDDLExecutor {
   ...
   * @throws IOException if a remote or network exception occurs
   */
  void createTableIfNotExists(HTableDescriptor descriptor, @Nullable byte[][] splitKeys)
    throws IOException;
   ...
   */
  void modifyTable(String namespace, String name, HTableDescriptor descriptor) throws IOException, NotFoundException;
